...
import com.example.jpah2m2m.repository.AuthorRepository;
import com.example.jpah2m2m.repository.BookRepository;
...
public class BookRepositoryTests {
    ...
    public void deleteAll() {
        bookRepository.deleteAll(); // 删除所有书籍，级联删除关联的作者，但是没有与书籍关联的作者不会被删掉
        authorRepository.deleteAll(); // 删除所有作者，只能删除没有与书籍关联的作者，与书籍有关联的作者无法被删除
    }
